...
def evaluate(cfg: StrategyConfig, seeds: list[int]) -> dict:
    results = []
    for seed in seeds:
...
def main() -> int:
    ...
    grid = {
        "scan_ring_radius_m": [1150.0, 1300.0, 1560.0],
        "task_bias_clear_m": [0.0, 400.0],
