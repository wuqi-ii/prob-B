...
class Config:
    ...
    def __post_init__(self):
        ...
        if not 0 <= self.source_min_radius_m < self.max_reception_m:
            raise ValueError("source_min_radius_m must lie in [0, max_reception_m).")
    ...
    @property
    def h(self):
        return self.max_reception_m * math.tan(self.eps)
