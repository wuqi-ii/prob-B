...
from cumcm_b3.metrics import append_jsonl, dumps_strict, write_json  # noqa: E402
...
class TestStrictJsonArtifacts(unittest.TestCase):
    ...
    def test_effective_config_is_strict_json(self):
        ...
        self.assertEqual(parsed["scan_ring_radius_m"], 1150.0)
        self.assertEqual(parsed["second_station_local_a_m"], 764.0)
        self.assertEqual(parsed["second_station_local_b_m"], 526.0)
