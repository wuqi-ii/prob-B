...
def plot_constraint_region(path, config, summary, poly, poly_full):
    ...
    ax.plot([0,config.max_reception_m],[0,0],color=BLUE,lw=.9,ls="--",zorder=3)
    ...
    ax.set_xlim(-90,config.max_reception_m+65)
    ...
    x=np.linspace(xmin-40,xmax+40,700);R=config.guaranteed_reception_m;L=config.max_reception_m
